...
from vertical_fl.strategy_attack_gradient import ConfigServerAttackGradient, CLIPFederatedStrategyAttackGradient


def server_fn(context: Context) -> ServerAppComponents:
    """Construct components that set the ServerApp behaviour."""
    run_conf = context.run_config
    config = ConfigServerAttackGradient(
    ...
    strategy = CLIPFederatedStrategyAttackGradient(
        config=config,
