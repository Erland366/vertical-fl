...
from vertical_fl.strategy_attack_gradient_online import ConfigServerAttackGradientOnline, CLIPFederatedStrategyAttackGradientOnline


def server_fn(context: Context) -> ServerAppComponents:
    """Construct components that set the ServerApp behaviour."""
    run_conf = context.run_config
    config = ConfigServerAttackGradientOnline(
    ...
    strategy = CLIPFederatedStrategyAttackGradientOnline(
        config=config,
